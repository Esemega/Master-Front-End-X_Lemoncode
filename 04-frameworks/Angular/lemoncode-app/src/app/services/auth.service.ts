...
const getUser = (user: UserEntity): UserSession => {
  return {
    username: 'master8',
    token:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Im1hc3RlcjhAbGVtb25jb2RlLm5ldCIsInBhc3N3b3JkIjoiMTIzNDU2NzgifQ.-k6L5ATX3NeF2bwIIQCldqWo63x7ty2dMe3c4O8-rxs',
  };
};
